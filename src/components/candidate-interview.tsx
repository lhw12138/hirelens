...
export function CandidateInterview({ token }: { token: string }) {
  ...
  return <main className="candidate-shell">
    <header className="candidate-header"><div className="candidate-brand"><span>HL</span><div><strong>HireLens</strong><small>结构化候选人面试</small></div></div><div className="privacy-seal"><ShieldCheck size={15} /> 本场回答仅用于招聘评估</div></header>
